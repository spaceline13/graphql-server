      ...
      return _react.Children.map(children, function (child) {
        ...
        if (isTitle) {
          var _ret2 = function () {
            ...
            var isActive = (0, _has3.default)(child, 'props.active') ? child.props.active : activeIndex === currentIndex;
        ...
        if (isContent) {
          var _currentIndex = contentIndex;
          var _isActive = (0, _has3.default)(child, 'props.active') ? child.props.active : activeIndex === _currentIndex;
          contentIndex++;
